...
function vowelCount(str){
    ...
    const vowels = stringArray.filter(function(a){
    ...
    vowels.forEach(function(a){
        ...
        if (countObject[a.toLowerCase()] === undefined || countObject[a.toLowerCase()] === NaN)
            countObject[a.toLowerCase()] = 1;
        else
            countObject[a.toLowerCase()] += 1;
    });
    return countObject;
...
function findInObj(arr, key, searchValue) {
    ...
    arr.forEach(function(a, index){
        if (found === false && a[key] === searchValue){
            foundobj = a;
            found = true;
        }
    });
...
function removeVowels(str) {
    ...
    return vowels.join('').toLowerCase();
}
...
function doubleOddNumbers(arr) {
    return doubleValuesWithMap(arr.filter(function(a){
        return a % 2 === 1;
    }));
}
